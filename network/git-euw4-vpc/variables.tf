variable "company_prefix" {
  description = "data block company prefix variable"
  type        = string
  default     = ""
}
...
variable "project_git_prefix" {
  description = "data block project prefix variable"
  type        = string
  default     = ""
}

variable "project_shared_prefix" {
  description = "data block project prefix variable"
  type        = string
  default     = ""
}

variable "peer_network_prefix" {
...
variable "suffix" {
  description = "suffix variable for test enviroment"
  type        = string
  default     = ""
}

variable "vpc_host_network_name" {
  description = "vpc_host_network_name."
  type        = string
  default     = " "
}

variable "vpc_srv_network_name" {
  description = "vpc_srv_network_name."
  type        = string
  default     = " "
}
